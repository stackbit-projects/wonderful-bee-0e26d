...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff0e26d1ff91e00158892e0
...
To start editing your site, you can use the Sanity interface at https://wonderful-bee-0e26d.sanity.studio/.
...
Generated at `2021-01-02T21:21:59.432Z` by Stackbit version `0.3.42`.